...
public interface IAppointmentService
{
    ...
    Task<Result<AppointmentDto>> GetAppointmentByIdAsync(
        string id,
        CancellationToken cancellationToken
    );
    ...
    Task<Result<IEnumerable<AppointmentDto>>> GetAppointmentsByDoctorIdAsync(
        string doctorId,
        CancellationToken cancellationToken
    );
    Task<Result<IEnumerable<AppointmentDto>>> GetAppointmentsByPatientIdAsync(
        string patientId,
        CancellationToken cancellationToken
    );
}
